...
def back_Translation(text: str, nbre_samples=1) -> list[str]:
    """
...
def synonym_Replacement_nltk(text: str) -> str:
    """
...
def synonym_Replacement(text: str, nbre_samples=-1) -> list[str]:
    """
    Augments the given text by replacing the words with synonyms.
